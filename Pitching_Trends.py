...
def upload_to_sheets(df):
    ...
    try:
        ...
        worksheet = sh.worksheet("Recent Hot Pitchers")
...
def build_pitching_rates(df):
    ...
    pybaseball pitching_stats_range columns (common): IP, H, ER, BB, SO, HR, HBP, BF, R
    """
...
def main():
    ...
    hot = df.sort_values(
        SORT_BY,
        ascending=(SORT_BY in ["ERA", "WHIP", "FIP_lite", "BB9", "HR9"]),
    ).head(TOP_N).copy()
